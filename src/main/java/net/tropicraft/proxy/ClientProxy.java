...
import net.tropicraft.client.renderer.block.KoaChestRenderHandler;
...
public class ClientProxy extends CommonProxy {
    ...
    public void initRenderHandlersAndIDs() {
        ...
        TCRenderIDs.koaChest = RenderingRegistry.getNextAvailableRenderId();
        ...
        RenderingRegistry.registerBlockHandler(new KoaChestRenderHandler());
